...
import type { ColumnRowProps } from './TableNode.types';
...
export const ColumnRow = memo(function ColumnRow({ column, tableId, isHovered: _isHovered }: ColumnRowProps): ReactNode {
